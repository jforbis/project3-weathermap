    ...
    d3.json(data2, d =>{
        ...
        function chooseStyle(feature) {
            return {
                opacity: 1,
                fillOpacity: 1,
                fillColor: chooseColor(feature.properties['Median Age']),
                color: "black",
                radius: chooseSize(feature.properties['Median Age']),
                stroke: true,
                weight: 2
            };
        }
        ...
        function chooseSize(Population) {
            switch(true) {
                case Population > 45:
                    return 20;
                case Population < 45 && Population >= 40:
                    return 17;
                case Population < 40 && Population >= 35:
                    return 14;
                case Population < 35 && Population >= 30:
                    return 11;
                case Population < 30 && Population >= 25:
                    return 8;
                default:
                    return 5;
                }
